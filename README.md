...
- Dentro de **Cargue aquí su ruta**, el análisis GIS genera una superficie de densidad sin radio fijo: detecta automáticamente los puntos marcados de un archivo o los puntos obligatorios del planificador, calcula una malla adaptativa, clasifica la concentración como Sin concentración/Baja/Alta/Muy alta y permite descargar `capa_raster_densidad.geojson`.
